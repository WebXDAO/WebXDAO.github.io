...
const ProjectCard = ({
  ...
  return (
    <div
      ...
      className={cn(
        fontSans.variable,
        "flex w-[356px] flex-col items-start justify-between gap-8 justify-self-center rounded-[10px] border border-black/5 px-[28px] pb-[24px] pt-[28px] shadow-[0px_0px_10px_0px_#00000010] hover:shadow-sm dark:border-white/20 dark:shadow-[0px_0px_10px_0px_#FFFFFF25] md:w-full md:lg:min-h-[240px]"
      )}
    >
