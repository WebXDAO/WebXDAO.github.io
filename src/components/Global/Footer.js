    ...
    <footer className="bg-transparent">
      <div className="max-w-screen-xl px-4 pt-16 pb-6 mx-auto sm:px-6 lg:px-8 lg:pt-24">
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          <div className="">
            <div className="flex justify-center text-teal-600 sm:justify-center items-center h-full">
              <a href="#">
                <span className="sr-only">WebX DAO</span>
                <img
                  className="w-auto h-32 sm:h-32 md:mb-8"
          ...
          <div className="grid grid-cols-1 m-auto gap-24 sm:grid-cols-2 lg:col-span-2 md:grid-cols-4">
            {navigation.map((item) => (
              <>
                <div
