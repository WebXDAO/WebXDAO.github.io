/* eslint-disable @next/next/no-img-element */ // The GitHub Urls can't be used with the Image tag
...
export default function Moderators () {
  const SEO = {
    ...
    description:
      'Moderators of WebXDAO, an open-source community working around the future of the web. Learn blockchain technology together.',
    openGraph: {
      type: 'website',
      locale: 'en_US',
      url: 'https://webxdao.github.io/moderators',
      site_name: 'WebXDAO Moderators',
      title: 'WebXDAO | Moderators',
      description:
        'Moderators of WebXDAO, an open-source community working around the future of the web. Learn blockchain technology together.'
    }
    ...
    <div>
      ...
      <section className="text-white text-center bg-[#00007f]">
        <div className="px-20 py-20">
          <h1 className="font-bold text-5xl antialiased">
          ...
          <div className="container mx-auto">
            <div className="flex flex-wrap md:-mx-3 gap-6">
              <div className="text-black grid grid-col-1 p-3 gap-y-3 md:grid lg:grid-cols-2 md:gap-3 md:p-3">
                {moderatorsData.map(
                  ({ name, bio, twitterUrl, githubUrl }, index) => (
                    <div
                      key={name + index}
