...
const mod = [
  ...
  },
  {
    ...
    role: "Mods / Maintainer",
    imageUrl: "https://github.com/emotidev.png",
  ...
  },
  {
    name: "Abhinav MV",
    role: "Maintainer",
    imageUrl: "https://github.com/AbhinavMV.png",
      ...
      <div className="py-24 sm:py-32">
            ...
            {core.map((person) => (
              <li key={person.name} className="rounded-2xl bg-gray-800 px-8 py-10">
                ...
                <ul role="list" className="mt-6 flex justify-center gap-x-6">
                  <li>
                    <Link href={person.githubUrl} className="text-gray-400 hover:text-gray-300">
                  ...
                  <li>
                    <Link href={person.twitterUrl} className="text-gray-400 hover:text-gray-300">
                  ...
                  <li>
                    <Link href={person.linkedinUrl} className="text-gray-400 hover:text-gray-300">
        ...
        <div className="py-24 sm:py-32">
          <div className="mx-auto max-w-7xl px-6 text-center lg:px-8">
            <div className="mx-auto max-w-2xl">
              <h2 className="text-3xl font-bold tracking-tight text-white sm:text-4xl">
                Maintainers and Moderators Team
              </h2>
              <p className="mt-4 text-lg leading-8 text-gray-400">
                Our maintainers and moderators play a crucial role in our community projects by
                keeping our codebase in good shape and making sure our community stays active and
                friendly.
              </p>
            </div>
            <ul
              role="list"
              className="mx-auto mt-20 grid max-w-2xl grid-cols-2 gap-x-4 gap-y-16 text-center sm:grid-cols-3 md:grid-cols-3 lg:mx-0 lg:max-w-none lg:grid-cols-3 xl:grid-cols-3"
            >
              {mod.map((person) => (
                <li key={person.name}>
