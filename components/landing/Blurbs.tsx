      ...
      <section className=" flex justify-center px-4 py-0 md:px-10">
        <div className="my-12 flex flex-col md:flex-row md:gap-8">
          <div className="flex flex-col items-center justify-center gap-3 text-center">
            <div className="border-l-3 flex justify-center rounded-lg cursor-pointer border-white bg-white p-8 shadow-md shadow-purple-300 hover:scale-105 hover:-translate-y-2 transition-all duration-300">
