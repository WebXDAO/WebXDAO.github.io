        ...
        <section className="container mt-20 grid items-center justify-center gap-6 pb-8 pt-6  md:py-10">
            ...
            <div className="mt-10 flex flex-wrap justify-center gap-10">
                {data.map(({ img, para, url }, index) => (
                    <div key={index} className="flex max-w-[400px] cursor-pointer flex-col rounded-lg bg-white shadow-md shadow-purple-300 transition-all duration-200 ease-in hover:z-50 hover:shadow-lg hover:shadow-purple-400 sm:hover:scale-105">
                        <Image className="w-full rounded-md p-2" src={img} width={600} height={450} alt="" />
