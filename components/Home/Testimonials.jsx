            ...
            >
              <div className='flex py-4'>
                <div className='flex items-center'>
                  {Array.from(Array(Math.floor(rating)).keys()).map((item, index) => (
                    <svg
                      key={item + index}
                  ...
                  {Array.from(Array(5 - Math.floor(rating)).keys()).map((item, index) => (
                    <svg
                      key={item + index}
              ...
              <div className='flex flex-row items-center justify-start py-2'>
                ...
                <div className='flex flex-col justify-center pl-3'>
                  <div className='w-full font-bold text-xl text-gray-800'>{name}</div>
