    ...
    <section className="container mt-20 grid items-center justify-center gap-6 pb-8 pt-6  md:py-10">
      ...
      <div className="mt-10 flex flex-wrap justify-center gap-24">
        {data.map(({ img, para, url }, index) => (
          <div
            key={index}
            className="flex max-w-xs flex-col rounded-lg bg-white shadow-md shadow-purple-300"
          >
            ...
            <div className="flex px-6 pt-4">
              <Link
                href={url}
                className="font-inter text-14.0418 mb-2 flex cursor-pointer gap-6 rounded border-2 border-solid border-black px-4 py-1 font-semibold text-black"
              >
                <Image
                  src="/Arrow1.png"
                  alt="arrow"
