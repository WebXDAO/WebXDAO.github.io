        ...
        <div className='w-full flex flex-col md:flex-row py-6 gap-x-4'>
            ...
            <ul className='list-reset mb-6'>
              {resources.map((item, index) => (
                <li key={item.name + index} className='mt-2 mr-2 block md:mr-0'>
                  <a href={item.url} className='no-underline text-gray-400 hover:text-blue-500'>
                    {item.name}
                  </a>
                </li>
              ))}
          ...
          <div className='flex-1'>
            ...
            <ul className='list-reset mb-6'>
              <li className='mt-2 mr-2 md:block md:mr-0'>
                <a href='#' className='no-underline text-gray-400 hover:text-blue-500'>
                  Disclaimer
                </a>
              </li>
          ...
          <div className='flex-1'>
            ...
            <ul className='list-reset mb-6'>
              ...
              <li className='mt-2 inline-block mr-2 md:block md:mr-0'>
                <a className='no-underline text-gray-400'>Community for Dapps & $Dev</a>
              </li>
            </ul>
          </div>
        </div>
